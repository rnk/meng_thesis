...
described in Section \ref{sec:decoding_with_control_flow}.
% TODO: Add this section and label.
...
register.  We discuss more complex cases in Section
\ref{sec:complex_lea_folding}.  After we apply our instruction folding
optimizations, we get the assembly listing in Figure \ref{fig:inscount_lea}.
