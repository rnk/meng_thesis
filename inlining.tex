...
By coalescing calls together we are only able achieve a 20\% improvement over
...
After applying both optimizations, we get a satisfactory 3.1 speedup, bringing
