...
We limit the size of the code we inline to avoid code bloat and excess memory
usage.
...
After applying both optimizations, we get a satisfactory 2.1 speedup, bringing
